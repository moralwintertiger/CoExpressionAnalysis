...
def cox(file, size_filter_1, size_filter_2):
...
def percent_filter(file, size_filter_1, size_filter_2):
    ...
    nb_labels_red, nb_labels_green, nb_labels_overlap = cox(file, size_filter_1, size_filter_2)
    percent_of_red = (nb_labels_overlap) / (nb_labels_red)
    percent_of_green  = (nb_labels_overlap) / (nb_labels_green)

    return(percent_of_red, percent_of_green)
